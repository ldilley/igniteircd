 ...
 *
 *   $Id: m_restart.c,v 1.1.1.1 2006/03/08 23:28:10 malign Exp $
 */
                  ...
                  char *parv[])
{
  ...
  Log("RESTART issued by %s.", get_client_name(sptr, SHOW_IP));
  ircsprintf(buf, "RESTART issued by %s.", get_client_name(sptr, SHOW_IP));
  restart(buf);
